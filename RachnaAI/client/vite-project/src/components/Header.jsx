...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] max-auto mt-10 text-center'>Turn text to <span className='text-blue-600'
      initial={{opacity:0}}
      animate={{opacity:1}}
      ...
      className='mt-2 text-neutral-600'>Generated images from Rachna-AI</motion.p>
