...
const BuyCredit = () => {
  ...
  return (
    ...
    viewport={{once:true}}
    className='min-h-screen text-center pt-14 mb-10'>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item , index)=>(
          <div key={index} className='bg-white drop-sadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scle-105 transition-all duration-500'>
