      ...
      <div >
        {user ? (
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            {/* Internal routing for Image to Text */}
            <Link to="/ImageToText" className='cursor-pointer'>
              Image to Text
            </Link>

            {/* Internal routing for Logo Maker */}
            <Link to="/LogoMaker" className='cursor-pointer'>
              Logos
            </Link>
